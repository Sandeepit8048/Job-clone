  ...
  >
      ...
      <div className="chatbotPopUp">
        {show ? (
          ...
          <div className="collapseMsgWrapper">
            ...
            <div className="collapseBotItem" style={{ fontSize: '18px' }}>
              <span className="botText">Want to apply to jobs? Register now!</span>{' '}
            </div>
            <div className="collapseBotChips">
              <button
                className="singleSelectChip"
                style={{
                  fontSize: '18px',
        ...
        <div className="floatIcon" onClick={displayMessage}>
          <div className="floatingChatIcon">
            <div className="chatbotOnline">
              <div className="online"></div>
            </div>
            <img
              src="//static.naukimg.com/s/7/103/i/naukriIcon.74e6a29a.png"
              className="chatbotNaukIcon"
            />
          </div>
        </div>
      </div>
      ...
      >
        <div
          ...
          className="naukri-wdgt role-collection-wdgt naukri-js-wdgt"
        ...
        >
          <div id="role-collection-wdgt">
            <div className="role-collection-wdgt">
              <div className="card-container">
                ...
                <div className="right-section">
                  <div className="swiper-container roleColSwiperWidget premium-swiper-wrap swiper-container-initialized swiper-container-horizontal">
                    <div
                      className=" premium-collection swiper-wrapper"
                      style={{
                    ...
                    >
                      <div
                        className="swiper-slide tupple swiper-slide-active"
                        index="1"
                        style={{ width: '590px' }}
                      >
                        <div className="chip-container">
                          <div className="chip-case">
                            <div className="chip">
                              <div className="chip-text">
                                <a
                                  href="https://www.naukri.com/full-stack-developer-jobs?src=popular_roles_homepage_srch"
                                  className="chip-heading"
                                >
                      ...
                      <div
                        className="swiper-slide tupple swiper-slide-next"
                        index="2"
                      >
                        <div className="chip-container">
                          <div className="chip-case">
      ...
      >
        <div
          ...
          className="naukri-wdgt naukri-ab-interview-wdgt naukri-js-wdgt"
        ...
        >
          <div id="ab-interview-wdgt">
            <div className="ab-interview-wdgt">
              <div className="card-container" data-label="by Ambition Box">
                <div className="one">
                  <h3 className="heading">Prepare for your next interview</h3>
                ...
                <div className="two">
                  ...
                  <div className="chip">
                    ...
                    <div className="chip-text">
                      ...
                      <br />
                      <p className="chip-count">1.7K+ Interviews</p>
                    </div>
                  </div>
                  <div className="chip">
                    <div className="chip-image">
                    ...
                    <div className="chip-text">
                      ...
                      <br />
                      <p className="chip-count">1.6K+ Interviews</p>
                    </div>
                  </div>
                  <div className="chip">
                    <div className="chip-image">
                    ...
                    <div className="chip-text">
                      ...
                      <br />
                      <p className="chip-count">2.5K+ Interviews</p>
                    </div>
                  </div>
                  <div className="chip">
                    <div className="chip-image">
                    ...
                    <div className="chip-text">
                      ...
                      <br />
                      <p className="chip-count">488 Interviews</p>
                    </div>
                  </div>
                  <div className="chip">
                    <div className="chip-image">
                    ...
                    <div className="chip-text">
                      ...
                      <br />
                      <p className="chip-count">816 Interviews</p>
                    </div>
                  </div>
                  <div className="chip">
                    <div className="chip-image">
                    ...
                    <div className="chip-text">
                      ...
                      <br />
                      <p className="chip-count">2K+ Interviews</p>
                    </div>
                  </div>
                ...
                <div className="three">
                  <p className="card-heading">Interview questions by role</p>
                  <div>
                    <div className="section3">
                      ...
                      <p className="role-count"> (7.2K+ questions)</p>
                    </div>
                    <hr className="hrLine" />
                  </div>
                  <div>
                    <div className="section3">
                      ...
                      <p className="role-count"> (2.8K+ questions)</p>
                    </div>
                    <hr className="hrLine" />
                  </div>
                  <div>
                    <div className="section3">
                      ...
                      <p className="role-count"> (2.4K+ questions)</p>
                    </div>
                    <hr className="hrLine" />
                  </div>
                  <div>
                    <div className="section3">
                      ...
                      <p className="role-count"> (894 questions)</p>
                    </div>
                    <hr className="hrLine" />
                  </div>
                  <div>
                    <div className="section3">
                      ...
                      <p className="role-count"> (991 questions)</p>
                    </div>
                    <hr className="hrLine" />
                  </div>
                  <div>
                    <div className="section3">
                      ...
                      <p className="role-count"> (1.3K+ questions)</p>
                    </div>
                  </div>
                  <div className="view-roles">
                    <a
